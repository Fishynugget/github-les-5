...
public class SimplePet : MonoBehaviour
{
    ...
    public int cleanliness = 90; // 0-100
    ...
    void Start()
    {
        ...
        Debug.Log("Controls: F = Feed | P = Play | S = Sleep | H = Heal | C = Clean | I = Info");
        ShowPetInfo();
    }
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.H))
        {
            ...
            {
                Debug.Log(petName + " is already healthy!");
            }
        }
        if (Input.GetKeyDown(KeyCode.C))
        {
            ...
            {
                cleanliness += 25;
                Debug.Log("Cleaned " + "! Cleanliness is now: " + cleanliness);
                if (cleanliness > 100) cleanliness = 100;
            }
            else
            {
                Debug.Log(petName + " is already clean!");
            }
        }
    ...
    void ShowPetInfo()
    {
        ...
        Debug.Log("Cleanliness: " + cleanliness + "/100");
